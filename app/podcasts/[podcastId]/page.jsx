...
const page = () => {
  ...
  return (
    <div className="flex max-lg:flex-col gap-[4rem] mt-[3rem] p-[5rem_2rem] max-lg:p-[4rem_1rem]  serif bg-[#f6f6f6] rubik">
      ...
      <div className="flex flex-col gap-[1rem] bg-white w-[70%] max-lg:w-full p-[1rem] rounded-[1rem] ">
        ...
        <div className="flex max-lg:flex-col gap-[2rem]">
          <img
            src={imageUrl}
            className="max-lg:w-full w-[300px] h-[250px] object-cover rounded-[1rem] "
            alt="article-img"
          />
          ...
          <div className="flex flex-col gap-[2rem] w-full">
            <div className="flex flex-col  gap-[1rem] flex-wrap">
              ...
              <div className="bg-slate-100 p-[0.5rem]  rounded-[1rem] text-[0.75rem] flex-0 max-w-[30%] font-[300]">
                #{tag}
              </div>
        ...
        {relatedPodcastData.length > 0 ? (
          <div className="flex flex-col gap-[1rem]">
            {relatedPodcastData.map(({ _id, title, imageUrl }) => (
              <div
                className="flex bg-white p-[1rem] rounded-[1rem] gap-[1rem] cursor-pointer justify-between"
                key={_id}
